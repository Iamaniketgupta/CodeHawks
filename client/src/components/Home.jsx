...
<div className="scroller" data-direction="right" data-speed="slow">
  ...
  <img src="./src/assets/avatar1.webp" alt="" />
    <img src="./src/assets/avatar2.webp" alt="" />
    <img src="./src/assets/avatar3.jpg" alt="" />
    <img src="./src/assets/avatar4.webp" alt="" />
    <img src="./src/assets/avatar5.webp" alt="" />
    <img src="./src/assets/avatar7.jpg" alt="" />
  </div>
</div>
</div>
  </div>
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">Elevate your marketing game with Mentor Hub's expert mentors. Get tailored advice on strategy, digital marketing, and career advancement.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Navigate legal complexities with ease. Access guidance on compliance, contracts, and intellectual property from our seasoned legal mentors.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Boost productivity with automation. Learn to streamline workflows and integrate new technologies with our business automation mentors.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Master financial management with Mentor Hub's finance mentors. Gain insights on budgeting, analysis, and investment strategies.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Unlock creativity with our design mentors. Get feedback on user experience, product development, and brand strategy.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <p className="text-gray-500 dark:text-gray-400">Optimize your processes with Mentor Hub's operations mentors. Learn about supply chain management, project efficiency, and organizational optimization.</p>
          </div>
      </div>
  </div>
</div>
