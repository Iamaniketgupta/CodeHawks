...
const MenteeAllTasks = () => {
  ...
  return (
    ...
    <h2 className="text-2xl  font-bold mb-4 mt-3 bg-gray-400 rounded-xl px-4 py-2 ">My Tasks</h2>
      <div className="w-full flex flex-col items-center gap-4 p-4">
        {tasks.map(task => (
          <div key={task._id} className= " w-full bg-gray-800 text-white rounded-lg p-4 mb-4 relative md:w-[700px]">
          ...
          >
            <span className=''>Given by : </span>{task.mentor.fullName}
          </h3>
          </div>
        ))}
      </div>
